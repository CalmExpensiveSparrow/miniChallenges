...
class MyTestCase(unittest.TestCase):
    def test_find_one(self):
        for i in range(10_000):
            self.assertEqual(find_one_naiive(i), find_one_complete(i), msg=f"Failure at {i}")  # add assertion here
        ...
        # self.assertEqual(find_one_naiive(300), find_one_complete(300))  # add assertion here
        # self.assertEqual(find_one_naiive(360), find_one_complete(360))  # add assertion here
        ...
        # self.assertEqual(90051450678399649, find_one_complete(3**35))  # add assertion here
        # self.assertEqual(90051450678399649, find_one_complete(3**35))  # add assertion here
